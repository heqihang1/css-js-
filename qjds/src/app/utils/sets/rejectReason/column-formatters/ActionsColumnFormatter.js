...
export const ActionsColumnFormatter = (
  ...
  <div className="d-sm-flex flex-sm-row justify-content-end">
    {checkPermission("REJECT_REASON", "can_edit") && (
      <OverlayTrigger
    ...
    {checkPermission("REJECT_REASON", "can_delete") &&
      (row?.status === true ? (
        <OverlayTrigger
        ...
        >
          <a
            ...
            onClick={() => remove(row._id, row?.reject_reason)}
          >
        ...
        >
          <a
            ...
            onClick={() => approve(row._id, row?.reject_reason)}
          >
