...
export const ActionsColumnFormatter = (
  ...
  <div className="d-sm-flex flex-sm-row justify-content-end">
    {checkPermission("COMMERCIAL_SECTOR", "can_edit") && (
      <OverlayTrigger
    ...
    {checkPermission("COMMERCIAL_SECTOR", "can_delete") &&
      (row?.status === true ? (
        <OverlayTrigger
        ...
        >
          <a
            ...
            onClick={() => remove(row._id, row?.commercial_sector_name)}
          >
        ...
        >
          <a
            ...
            onClick={() => approve(row._id, row?.commercial_sector_name)}
          >
