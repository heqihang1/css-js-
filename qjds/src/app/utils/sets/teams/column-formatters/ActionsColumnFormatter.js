...
export const ActionsColumnFormatter = (
  ...
  <div className="d-sm-flex flex-sm-row justify-content-end">
    {checkPermission("TERMS_AND_CONDITION", "can_edit") && (
    ...
    {checkPermission("TERMS_AND_CONDITION", "can_delete") &&
      (row?.status === true ? (
        <OverlayTrigger
        ...
        >
          <a
            ...
            onClick={() => remove(row._id, row?.carPlateNumber)}
          >
        ...
        >
          <a
            ...
            onClick={() => approve(row._id, row?.carPlateNumber)}
          >
