...
export const ActionsColumnFormatter = (
  ...
  <div className="d-sm-flex flex-sm-row justify-content-end">
    {checkPermission("TERMINATION_REASON", "can_edit") && (
      <OverlayTrigger
    ...
    {checkPermission("TERMINATION_REASON", "can_delete") &&
      (row?.status === true ? (
        <OverlayTrigger
        ...
        >
          <a
            ...
            onClick={() => remove(row._id, row?.termination_reason)}
          >
        ...
        >
          <a
            ...
            onClick={() => approve(row._id, row?.termination_reason)}
          >
