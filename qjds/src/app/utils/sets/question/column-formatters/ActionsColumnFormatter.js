...
export const ActionsColumnFormatter = (
  ...
  <div className="d-sm-flex flex-sm-row justify-content-end">
    {checkPermission("QUESTION", "can_edit") && (
      <OverlayTrigger
    ...
    {checkPermission("QUESTION", "can_delete") &&
      (row?.status === true ? (
        <OverlayTrigger
        ...
        >
          <a
            ...
            onClick={() => remove(row._id, row?.question_title)}
          >
        ...
        >
          <a
            ...
            onClick={() => approve(row._id, row?.question_title)}
          >
